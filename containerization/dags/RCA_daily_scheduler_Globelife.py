...
dag = DAG('RCA_daily_schedular_globelife', default_args=default_args, schedule_interval=timedelta(hours=24),catchup=False)
...
passing = KubernetesPodOperator(namespace=namespace,
                          ...
                          cmds=["sh","-c", "ipython /home/jovyan/work/DAGS_Airflow/incident_rca_daily_scheduler.ipynb"],
                          labels={"notebook-name": "jupyter"},
                          service_account_name="spark-sa",
                          name="RCA_Daily_Scheduler",
                          env_vars={'CUSTOMER': 'globelife', 'SCOPE':'uat', 'NameSpace': namespace},
               		  ...
               		  volume_mounts=[ k8s.V1VolumeMount(mount_path='/home/jovyan/work', name='spark-data', sub_path=None, read_only=False)],
                          task_id="aiops-rca-daily-schedular-globelife",
                          get_logs=True,
                          dag=dag
                          )
