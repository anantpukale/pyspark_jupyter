...
dag = DAG('ICM_daily_schedule_globelife', default_args=default_args, schedule_interval=timedelta(hours=24),catchup=False)
...
passing = KubernetesPodOperator(namespace=namespace,
                          ...
                          cmds=["sh","-c", "ipython /home/jovyan/work/DAGS_Airflow/icm_daily_schedule.ipynb"],
                          labels={"notebook-name": "jupyter"},
                          service_account_name="spark-sa",
                          name="ICM_Daily_schedule_globelife",
               		  ...
               		  volume_mounts=[ k8s.V1VolumeMount(mount_path='/home/jovyan/work', name='spark-data', sub_path=None, read_only=False)],
                          task_id="aiops-icm-daily-schedule-globelife",
                          get_logs=True,
                          dag=dag
                          )
