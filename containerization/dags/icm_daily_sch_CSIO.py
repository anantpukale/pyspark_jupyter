...
dag = DAG('ICM_daily_schedule_CSIO', default_args=default_args, schedule_interval='0 3 * * *',catchup=False)
...
passing = KubernetesPodOperator(namespace=namespace,
                          ...
                          name="ICM_Daily_schedule_CSIO",
                          resources={'limit_memory': "6G", 'limit_cpu': "2000m"},
			  env_vars={'CUSTOMER': 'CSIO', 'SCOPE':'uat', 'NameSpace': namespace},
               		  ...
               		  volume_mounts=[ k8s.V1VolumeMount(mount_path='/home/jovyan/work/', name='spark-data', sub_path=None, read_only=False)],
                          task_id="aiops-icm-daily-schedule-CSIO",
                          get_logs=True,
                          dag=dag
                          )
