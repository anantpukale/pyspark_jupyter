...
dag = DAG('ICM_Model_regeneron', default_args=default_args, schedule_interval=timedelta(hours=48),catchup=False)
...
passing = KubernetesPodOperator(namespace=namespace,
               		  ...
               		  volume_mounts=[ k8s.V1VolumeMount(mount_path='/home/jovyan/work', name='spark-data', sub_path=None, read_only=False)],
                          task_id="aiops-icm-modeling-regeneron",
                          get_logs=True,
                          dag=dag
                          )
