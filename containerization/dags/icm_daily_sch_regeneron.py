...
dag = DAG('ICM_daily_schedule_regeneron', default_args=default_args, schedule_interval='0 9 * * *',catchup=False)
...
passing = KubernetesPodOperator(namespace=namespace,
                          ...
                          name="ICM_Daily_schedule_regeneron",
                          env_vars={'CUSTOMER': 'regeneron', 'SCOPE':'uat', 'NameSpace': namespace},
               		  ...
               		  volume_mounts=[ k8s.V1VolumeMount(mount_path='/home/jovyan/work', name='spark-data', sub_path=None, read_only=False)],
                          task_id="aiops-icm-daily-schedule-regeneron",
                          get_logs=True,
                          dag=dag
                          )
